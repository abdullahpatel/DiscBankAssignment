...
public class ClientAccountService {
	...
	public List<ClientAccount> findTransactionalAccountByClient(Long clientId, Calendar timestamp) {
		return clientAccountRepo.findTransactionalAccountsByClient(clientId);
	}
	
	public List<CurrencyAccount> findCurrencyAccountsByClient(Long clientId, Calendar timestamp) {
		...
		for (ClientAccount account: accounts) {
			...
			if (account.getCurrencyCode().getConversionIndicator().equals("/")) {
				randBalance = account.getDisplayBalance().multiply(BigDecimal.ONE.divide(account.getCurrencyCode().getRate()));
	...
	public List<DispensingNotes> withdrawCash(Long atmId, Long clientId, String accountNumber, BigDecimal requiredAmount, Calendar timestamp) {
